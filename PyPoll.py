...
# # To count up all the votes, we need to initialize a variable, which is called an accumulator, that will increment by 1 as we read each row in the for loop. For convenience, we will initialize a variable called total_votes to zero.
