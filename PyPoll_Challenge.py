...
file_to_save = '/Users/crkaide/OneDrive - IL State University/Vanderbilt/Vanderbilt/Assignments/3_Python/Election_Analysis/Analysis/election_results.txt'
# Attempted to troubleshoot relative file path; does not work on this machine.  Direct file path required.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_turnout_count):
            ...
            largest_turnout_county_name = county_name
